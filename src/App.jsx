...
import { Robot } from './components/MainComp';
// import CarComp from './components/CarComp';
import baffle from 'baffle'
// import CarModel from './components/CarComp';
    ...
    <>
      ...
      <ScrollControls pages={6} damping={0.1}>
        ...
        <Scroll html style={{width: '100%'}}>
          <h1 className='title' style={{ color: '#cdcbca',position: 'absolute', top: `65vh`,left: '50%', fontSize: '13em', transform: `translate(-50%,-50%)` }}>YASHRAJ</h1>
